...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-bar-chart" aria-hidden="true"></i> Statistique</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-bar-chart" aria-hidden="true"></i></li>
          <li class="breadcrumb-item" ><a href="Acceuil_Client" style = "color: var(--blue);">Statistique</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-6 ">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Statistiques annuelles</h3>
